...
extern class Music {
    ...
    public var ctxData: cpp.Pointer<Void>;
    /**
     * Music, audio stream, anything longer than ~10 seconds should be streamed
     * @return cpp: Music
     */
    static inline function create(stream: AudioStream, frameCount: cpp.UInt32, looping: Bool, ctxType: Int, ctxData: cpp.Pointer<Void>): Music {
